      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
          ...
          <div className="mt-4 h-64">
            {/* TODO: Implement Weekly Task Trends line chart (completed / not completed / overdue). */}
          </div>
        </div>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
          ...
          <div className="mt-4 h-64">
            {/* TODO: Implement Driver Task Completion bar chart with color-coded performance. */}
          </div>
        </div>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
          ...
          <div className="mt-4 h-64">
            {/* TODO: Implement Driver Task Duration analysis chart with average line & optional breakdown. */}
          </div>
        </div>
      </div>
    </section>
